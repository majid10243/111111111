...
root=tk.Tk(); root.title("AI Provider Free Model Scanner v7"); root.geometry("1600x900"); root.minsize(1200,700)

top=ttk.Frame(root,padding=10); top.pack(fill="x")
ttk.Label(top,text="AI Provider Free Model Scanner v7",font=("Segoe UI",18,"bold")).pack(side="left")
